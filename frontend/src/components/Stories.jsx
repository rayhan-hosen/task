...
export default function Stories() {
    return (
        <>
            ...
            <div className="_feed_inner_ppl_card_mobile" suppressHydrationWarning>
                <div className="_feed_inner_ppl_card_area_list">
                    <div className="_feed_inner_ppl_card_area_item">
                        <div className="_feed_inner_ppl_card_area_story">
                            <img src="/assets/images/card_ppl1.png" alt="Image" style={{ width: '60px', height: '60px', borderRadius: '50%', objectFit: 'cover' }} />
                            <div className="_feed_inner_ppl_btn">
                                <button className="_feed_inner_ppl_btn_link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10">
                                        <path stroke="#fff" strokeLinecap="round" d="M.5 4.884h9M4.884 9.5v-9" />
                                    </svg>
                                </button>
                    ...
                    <div className="_feed_inner_ppl_card_area_item">
                        <div className="_feed_inner_ppl_card_area_story_active">
                            <img src="/assets/images/card_ppl2.png" alt="Image" style={{ width: '60px', height: '60px', borderRadius: '50%', objectFit: 'cover' }} />
                            <p className="_feed_inner_ppl_card_area_txt">Ryan...</p>
                        </div>
                    </div>
                    <div className="_feed_inner_ppl_card_area_item">
                        <div className="_feed_inner_ppl_card_area_story_active">
                            <img src="/assets/images/card_ppl3.png" alt="Image" style={{ width: '60px', height: '60px', borderRadius: '50%', objectFit: 'cover' }} />
                            <p className="_feed_inner_ppl_card_area_txt">Ryan...</p>
                        </div>
                    </div>
                    <div className="_feed_inner_ppl_card_area_item">
                        <div className="_feed_inner_ppl_card_area_story_active">
                            <img src="/assets/images/card_ppl4.png" alt="Image" style={{ width: '60px', height: '60px', borderRadius: '50%', objectFit: 'cover' }} />
                            <p className="_feed_inner_ppl_card_area_txt">Ryan...</p>
                        </div>
                    </div>
                    <div className="_feed_inner_ppl_card_area_item">
