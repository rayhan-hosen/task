                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        ...
                        <li className="nav-item _header_nav_item">
                            ...
                            >
                                ...
                                {showNotifications && (
                                    <div id="_notify_drop" className={`_notification_dropdown ${showNotifications ? 'show' : ''}`}>
                                                ...
                                                {[...Array(6)].map((_, i) => (
                                                    <div key={i} className="_notification_box">
                                                        <div className="_notification_image">
                                                            <img src="/assets/images/profile.png" alt="Image" className="_notify_img" />
                                                        </div>
                                ...
                                <ul className="_nav_dropdown_list">
                                    <li className="_nav_dropdown_list_item">
                                        <a href="#0" className="_nav_dropdown_link">
                                            <div className="_nav_drop_info" style={{ display: 'flex', alignItems: 'center' }}>
                                                <span>
